...
class burndown():
    ...
    def read_file(self,burndown_report):
    ...
    ####################################################################################################################
        ...
        logging.info('The Output Files are generated in : %s', output)
        df10 = df9[::-1]
        ...
        logging.info('The Output Data File Name is : %s', output + output_filename + '.xlsx')
        logging.info('The Output Image File Name is : %s', output + output_filename + '.png')
        ...
        logging.info('The Result Data & Image File Name is : %s', output + 'Result_' + output_filename + '.xlsx')
    ...
    def run_burndown(self,input_folder,log_folder,burndown_report):
            ...
            for filename in os.listdir(self.directory):
                ...
                if filename.startswith("resultsTC_") and (filename.endswith(".xlsx") or filename.endswith(".XLSX") or filename.endswith(".xls") or filename.endswith(".XLS")):
                    ...
                    try:
                        ...
                        self.read_file(burndown_report)
